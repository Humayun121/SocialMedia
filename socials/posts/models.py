...
class Post(models.Model):
    ...
    def save(self,*args,**kwargs):
        self.message_html = misaka.html(self.message) #If a person writes a markdown(link in their post) it won't look like a strange notation 
    ...
    class Meta:
        ordering = ['-created_at'] #- will show recent post
